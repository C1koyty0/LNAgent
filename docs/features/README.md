...
| [worldbook-document-ingestion-design.md](./worldbook-document-ingestion-design.md) | **世界观文档录入与结构化设计**（document-first、LLM 提炼、按 scope 注入） | 设计已确认，待实现 |
| [worldbook-implementation-plan.md](./worldbook-implementation-plan.md) | **世界观文档录入与结构化实施计划**（WK0–WK6，可跨 session 追踪） | 待实施 |

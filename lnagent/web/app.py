...
def _render_home(projects: list[Any]) -> str:
    ...
    body = (
        ...
        "<label>模板<select id='project-template'><option value=''>不使用模板</option></select></label>"
        ...
        "<label>叙述人称<input id='project-pov' type='text' placeholder='例如 第一人称'></label>"
        "<label>时态<input id='project-tense' type='text' placeholder='例如 过去时'></label>"
        "<label>题材<input id='project-genre' type='text' placeholder='例如 校园奇幻'></label>"
        "<label>语气<input id='project-tone' type='text' placeholder='例如 轻松治愈'></label>"
...
def _render_project(project_id: str) -> str:
    ...
    body = (
        ...
        "</section>"
        "<section id='worldbook-panel' class='panel worldbook-panel'>"
        "<div class='panel-header'>"
        "<h2>Worldbook</h2>"
        "<div id='worldbook-status' class='worldbook-status'><span class='badge worldbook-status-badge'>加载中…</span></div>"
        "</div>"
        "<p class='hint worldbook-panel-desc'>维护完整世界观文档，先提炼结构化 preview，再决定是否应用到 meta.world。</p>"
        "<label for='worldbook-source'>世界观文档</label>"
        "<textarea id='worldbook-source' rows='10' placeholder='在此粘贴完整世界观文档…'></textarea>"
        "<div class='button-row'>"
        ...
        "<div id='worldbook-preview-overview' class='sub-block worldbook-preview-overview'><p class='hint'>加载中…</p></div>"
        "<div class='worldbook-preview-grid'>"
        "<details id='worldbook-preview-global-rules' class='sub-block worldbook-preview-section' open><summary>全局规则</summary><p class='hint'>加载中…</p></details>"
        "<details id='worldbook-preview-scopes' class='sub-block worldbook-preview-section' open><summary>Scope 规则</summary><p class='hint'>加载中…</p></details>"
        "<details id='worldbook-preview-glossary' class='sub-block worldbook-preview-section'><summary>术语表</summary><p class='hint'>加载中…</p></details>"
        "<details id='worldbook-preview-open-questions' class='sub-block worldbook-preview-section'><summary>待解问题</summary><p class='hint'>加载中…</p></details>"
        "</div>"
        "</div>"
        "</section>"
        "<section class='panel'>"

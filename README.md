...
- [x] Web Brief 人工编辑（B2）
- [~] [可配置的文风与叙事模板](docs/features/style-template-implementation-plan.md)（S0 已实现；S1–S2 待续）
...
- [文风与叙事模板实施计划](docs/features/style-template-implementation-plan.md) — S0 已实现；S1–S2 待续

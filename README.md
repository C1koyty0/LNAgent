...
| 已有 | **第一版 Web/API**：项目列表、项目打开、讨论 / 写作双轨项目页、`discussion/*` / `writing/*` 结构化接口、写作 SSE 流式返回、侧栏 Discussion Brief 工作区（同步状态 / 刷新 / 清空） |
...
- 侧栏常驻 `Discussion Brief` 工作区：展示待办、约束、待解问题，区分空态 / 待刷新 / 已同步 / 原始讨论已清空等状态；刷新与清空操作归属 brief 面板
...
- [Web Brief 工作空间实施计划](docs/features/web-brief-workspace-plan.md) — B0–B1 已实现；B2 人工编辑待开始
